...
function calculateLargestProduct() {
    ...
    if (!isNaN(nValue) && nValue > 0) {
        const result = largestProductinaSeries(nValue);
        document.getElementById('result').textContent = `The largest product of ${nValue} adjacent digits is: ${result}`;
    } else {
